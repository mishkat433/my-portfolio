...
const GetResume = () => {
    return (
        <a
            ...
            className="btn bg-red duration-300 text-white bg-orange-500 mr-8 hover:bg-white shadow-md shadow-sec-red hover:text-black group border-red hover:border-red">
            Get Resume
